			...
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item">
						<a class="btn btn-sm btn-primary" href="{{ route('tour-guide.create') }}">Create New Tour Guide</a>
					</li>
				</ol>
			</div>
		</div>
		...
		<div class="col-12">
			<div class="card">
				<div class="card-header">
					<h3 class="card-title">Your all Tour Guide</h3>
				</div>
				<!-- /.card-header -->
				<div class="card-body">
						...
						<tbody>
							@foreach ($tourguides as $tour)
								<tr>
									...
									<td>{{ $tour->name }}</td>
									<td>
										{{ $tour->status == 1 ? 'Active' : 'Not Active' }}
									</td>
									<td>
										<img height="70" width="100" src="{{ Storage::disk('local')->url($tour->image) }}" alt="">
									</td>
									<td>
										<a href="{{ route('tour-guide.edit', $tour->id) }}" class="btn btn-sm btn-warning">Edit/Show</a>
